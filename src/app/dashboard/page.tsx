...
export default function Dashboard() {
  ...
  if(!farmer) return <div style={{textAlign: 'center', padding: '100px'}}>Loading...</div>;
    ...
    <div>
      ...
      <div style={{
        ...
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px', maxWidth: '1200px', margin: '0 auto'}}>
          ...
          <div style={{background: 'rgba(255,255,255,0.95)', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.2)'}}>
          ...
          <div style={{background: 'rgba(255,255,255,0.95)', padding: '20px', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.2)', border: '2px solid #4caf50'}}>
